  ...
  return (
    <>
        ...
        <form className="flex flex-row items-center gap-3">
          <input  className="border border-gray-400 rounded-lg  py-1.5 px-2.5 text-lg"    type="text" placeholder="Add a task" value={input} onChange={(e)=>setInput(e.target.value)}/>
